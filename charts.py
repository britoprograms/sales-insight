...
def option_from_sales(records: List[Dict[str, Any]], *, theme: str = "mono", title: str = "Weekly Sales"):
    ...
    return {
        ...
        "title": {"text": title, "left": "center", "textStyle": {"color": fg_color}},
        "tooltip": {"trigger": "axis"},
        "xAxis": {"type": "category", "data": weeks, "axisLabel": {"color": fg_color}},
        "yAxis": {"type": "value", "axisLabel": {"color": fg_color}, "splitLine": {"show": False}},
...
def option_compare_decliners_growers(
    ...
    *,
    ...
    # Define chart-specific colors based on theme
    if theme == "light":
        chart_colors = {"decl": "#0ea5e9", "grow": "#22c55e"}
    elif theme == "matrix":
        chart_colors = {"decl": "#22d3ee", "grow": "#86efac"}
    else:  # mono
        chart_colors = {"decl": "#60a5fa", "grow": "#34d399"}
    
    p = {"fg": colors["fg"], **chart_colors}
